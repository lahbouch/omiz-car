        ...
        <div class="main-header">
                ...
                <div class="nav user-menu nav-list">
                    ...
                    <div class="me-auto d-flex align-items-center" id="header-search">					
                        ...
                        <div class="add-dropdown">
                            <router-link to="/admin-template/bookings/add-reservation" class="btn btn-dark d-inline-flex align-items-center">
                    ...
                    <div class="d-flex align-items-center header-icons">	
                        ...
                        <div class="nav-item dropdown has-arrow flag-nav nav-item-box">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
                                role="button">
                                <img src="@/assets/admin/img/flags/gb.svg" alt="Language" class="img-fluid">
                            </a>
                            <ul class="dropdown-menu p-2">
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="@/assets/admin/img/flags/gb.svg" alt="" height="16">English
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="@/assets/admin/img/flags/sa.svg" alt="" height="16">Arabic
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);" class="dropdown-item">
                                        <img src="@/assets/admin/img/flags/de.svg" alt="" height="16">German
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="theme-item">
                            <a href="javascript:void(0);" id="dark-mode-toggle" @click="toggleDarkMode" :class="{ 'theme-toggle btn btn-menubar activate': true, 'activate' : isDarkMode }">
                            <i class="ti" :class="[isDarkMode ? 'ti-sun-high' : 'ti-moon']"></i>
                        </a>
                        </div>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="active-notification">
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg offline me-2 flex-shrink-0">
                                                        <img src="@/assets/admin/img/profiles/avatar-02.jpg" alt="Profile" class="rounded-circle">
                                                    </a>
                                            ...
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg offline me-2 flex-shrink-0">
                                                        <img src="@/assets/admin/img/profiles/avatar-05.jpg" alt="Profile" class="rounded-circle">
                                                    </a>
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg me-2 flex-shrink-0">
                                                        <img src="@/assets/admin/img/profiles/avatar-04.jpg" alt="Profile" class="rounded-circle">
                                                    </a>
                                                    <div class="flex-grow-1">
                                            ...
                                            <div class="notification-list">
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0);" class="avatar avatar-lg me-2 flex-shrink-0">
                                                        <img src="@/assets/admin/img/profiles/avatar-01.jpg" alt="Profile" class="rounded-circle">
                                                    </a>
                                                    <div class="flex-grow-1">
                                        ...
                                        <div class="tab-pane fade" id="unread-notification">
                                            ...
                                            <div class="notification-list">
                                                <a href="javascript:void(0);">
                                                    <div class="d-flex align-items-center">
                                                        <span class="avatar avatar-lg offline me-2 flex-shrink-0">
                                                            <img src="@/assets/admin/img/profiles/avatar-06.jpg" alt="Profile" class="rounded-circle">
                                                        </span>
                                                        <div class="flex-grow-1">
                                        ...
                                        <div class="tab-pane fade" id="archieve-notification">
                                            <div class="d-flex justify-content-center align-items-center p-3">
                                                <div class="text-center ">
                                                    <img src="@/assets/admin/img/icons/nodata.svg" class="mb-2" alt="nodata">
                        ...
                        <div>
                            <router-link to="/admin-template/reports/income-report" class="btn btn-menubar">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu p-3">
                                <ul>
                                    <li>
                                        <router-link to="/admin-template/rentals/add-car" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-car me-2"></i>Car
                                        </router-link>
                                    </li>
                                    <li>
                                        <router-link to="/admin-template/bookings/add-quotations" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-file-symlink me-2"></i>Quotation
                                        </router-link>
                                    </li>
                                    <li>
                                        <router-link to="/admin-template/rentals/pricing" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-file-dollar me-2"></i>Seasonal Pricing
                                        </router-link>
                                    </li>
                                    <li>
                                        <router-link to="/admin-template/rentals/extra-services" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-script-plus me-2"></i>Extra Service
                                        </router-link>
                                    </li>
                                    <li>
                                        <router-link to="/admin-template/rentals/inspections" class="dropdown-item d-inline-flex align-items-center">
                                            <i class="ti ti-dice-6 me-2"></i>Inspection
                                        </router-link>
                                    </li>
                                    <li>
                                        <router-link to="/admin-template/rentals/maintenance" class="dropdown-item d-inline-flex align-items-center">
                        ...
                        <div class="dropdown profile-dropdown">
                            <a href="javascript:void(0);" class="d-flex align-items-center" data-bs-toggle="dropdown"  data-bs-auto-close="outside">
                                <span class="avatar avatar-sm">
                                    <img src="@/assets/admin/img/profiles/avatar-05.jpg" alt="Img" class="img-fluid rounded-circle">
                                </span>
                            </a>
                            <div class="dropdown-menu">
                                <div class="profileset d-flex align-items-center">
                                    <span class="user-img me-2">
                                        <img src="@/assets/admin/img/profiles/avatar-05.jpg" alt="">
                                    </span>
                                    <div>
                                ...
                                <router-link class="dropdown-item d-flex align-items-center" to="/admin-template/account-settings/profile-setting">
                                    <i class="ti ti-user-edit me-2"></i>Edit Profile
                                </router-link>
                                <router-link class="dropdown-item d-flex align-items-center" to="/admin-template/finance/payments">
                                ...
                                <router-link class="dropdown-item d-flex align-items-center" to="/admin-template/account-settings/security-setting">
                                ...
                                <div class="dropdown-divider my-2"></div>
                                <router-link class="dropdown-item logout d-flex align-items-center justify-content-between" to="/admin-template/">
            ...
            <div class="dropdown mobile-user-menu">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <router-link class="dropdown-item" to="/admin-template/account-settings/profile-setting">Settings</router-link>
                    <router-link class="dropdown-item" to="/admin-template/">Logout</router-link>
                </div>
            </div>
            <!-- /Mobile Menu -->
