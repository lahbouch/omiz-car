                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="pass-group">
                                        <input :type="showPassword ? 'text' : 'password'" value="123456" class="pass-input form-control">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <div class="text-end">
                                        <router-link to="/admin-template/forgot-password" class="link-default text-decoration-underline">Forgot Password</router-link>
                                    </div>
                                </div>
                                <div class="mt-3">
