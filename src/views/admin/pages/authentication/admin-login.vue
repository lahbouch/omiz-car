        ...
        <div class="col-lg-5 mx-auto">
          <form action="/admin-template/index" class="p-4">
            ...
            <div class="card authentication-card mb-0">
              <div class="card-body">
                <div
                  class="login-icon bg-dark d-flex align-items-center justify-content-center mx-auto mb-4"
                >
                ...
                >
                  ...
                  <div class="text-end">
                    <router-link
                      to="/admin-template/forgot-password"
                      class="link-default text-decoration-underline"
