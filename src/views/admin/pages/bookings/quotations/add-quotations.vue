                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-footer px-0 pb-0">
                                    <div class="d-flex align-items-center justify-content-end">
                                        <div class="field-btns">
                                            <button class="btn btn-light wizard-prev-btn me-2" @click="previousStep" :disabled="currentStep === 3" type="button"><i class="ti ti-chevron-left me-1"></i>Back to Info</button>
                                        </div> 
                                        <div class="field-btns">
