        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-plus me-2"></i>Add Category</a
            >
          </div>
        </div>
      </div>
      ...
      <div class="collapse" id="filtercollapse">
        <div class="filterbox mb-3 d-flex align-items-center">
          ...
          <div class="dropdown me-3">
            ...
            >
              <span class="badge badge-xs rounded-pill bg-success me-2">5</span>Category<i
                class="ti ti-x text-gray-5 ms-1"
              ></i>
            </a>
        ...
        <a-table class="table datatable" :columns="columns" :data-source="data">
          <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'CATEGORY'">
              <a href="javascript:void(0);" class="fw-medium">{{ record.CATEGORY }}</a>
            </template>
            <template v-if="column.key === 'NUMBEROFBLOGS'">
              <a href="javascript:void(0);" class="fw-medium">{{
                record.NUMBEROFBLOGS
              }}</a>
            </template>
            <template v-if="column.key === 'CREATEDDATE'">
              <span class="text-gray-9">{{ record.CREATEDDATE }}</span>
            </template>
...
const columns = [
  ...
  },
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.NUMBEROFBLOGs.toLowerCase();
        b = b.NUMBEROFBLOGs.toLowerCase();
        return a > b ? -1 : b > a ? 1 : 0;
      },
    },
  },
