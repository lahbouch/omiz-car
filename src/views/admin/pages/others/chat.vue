            ...
            <div class="slimscroll">
              ...
              <div class="sidebar-body chat-body" id="chatsidebar">
                <div class="chat-users-wrap">
                  <div class="chat-list">
                    <router-link to="/admin-template/others/chat" class="chat-user-list">
                      ...
                      <div class="chat-user-info">
                        <div class="chat-user-msg">
                          <h6>Anthony Lewis</h6>
                          <p>
                            <span class="animate-typing text-success"
                              >Typing
                    ...
                    <router-link to="/admin-template/others/chat" class="chat-user-list">
                      ...
                      <div class="chat-user-info">
                        ...
                        <div class="chat-user-time">
                          ...
                          <div class="chat-pin">
                            <i class="ti ti-video text-secondary me-2"></i>
                          </div>
                        </div>
                      </div>
                    </router-link>
                    ...
                    <router-link to="/admin-template/others/chat" class="chat-user-list">
                      ...
                      <div class="chat-user-info">
                        ...
                        <div class="chat-user-time">
                          ...
                          <div class="chat-pin">
                            <span class="badge badge-xs rounded-pill bg-info">2</span>
                          </div>
                        </div>
                      </div>
                    </router-link>
                    ...
                    <router-link to="/admin-template/others/chat" class="chat-user-list">
                      ...
                      <div class="chat-user-info">
                        ...
                        <div class="chat-user-time">
                          <span class="time">02:40 PM</span>
                          <div class="chat-pin">
                            <i class="ti ti-check text-gray-3"></i>
                          </div>
                        </div>
                      </div>
                    </router-link>
                      ...
                      <div class="chat-user-info">
                        ...
                        <div class="chat-user-time">
                          ...
                          <div class="chat-pin">
                            ...
                            <i class="ti ti-checks text-gray-5"></i>
                          </div>
                        </div>
                      </div>
                    </router-link>
                  ...
                  <div class="chat-content">
                    ...
                    <div class="chat-info">
                      <div class="message-content">
                        Hello <span class="text-primary">@Keene</span> <br />
                        I'm looking to rent a car next weekend. Do you have any cars
                        available?
                      ...
                      <div class="chat-actions">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-3">
                          ...
                          <li>
                            <a class="dropdown-item" href="#"
                              ><i class="ti ti-box-align-right me-2"></i>Archeive Chat</a
                            >
                          </li>
                          <li>
                            <a class="dropdown-item" href="#"
                ...
                <div class="chats chats-right">
                  <div class="chat-content">
                    <div class="chat-profile-name text-end">
                      <h6>
                        Horace Keene<i class="ti ti-circle-filled fs-7 mx-2"></i
                        ><span class="chat-time">08:00 AM</span
                  ...
                  <div class="chat-content">
                    ...
                    <div class="chat-info">
                      <div class="message-content">
                        ...
                        to ensure you’re available during your usual working hours and
                        keep your manager updated if anything changes.
                        <div class="emoj-group">
                          <ul>
                            <li class="emoj-action">
                              <a href="javascript:void(0);"
                    ...
                    <div class="chat-info">
                      ...
                      <div class="message-content">
                        <div class="d-flex align-items-center">
                          <a href="javascript:void(0);"
                            ><span
                              class="p-2 bg-primary d-flex align-items-center justify-content-center rounded-circle me-2"
                              ><i class="ti ti-player-play"></i></span
                          ></a>
                          <img
            ...
            <form class="footer-form d-flex align-items-center">
              <div class="form-item">
                <a
                  ...
                  class="bg-dark text-white p-2 border rounded-circle d-flex align-items-center justify-content-center me-1"
                >
                  <i class="ti ti-dots-vertical"></i>
                </a>
              ...
              <div class="form-item emoj-action-foot">
                <div class="emoj-group-list-foot down-emoji-circle">
                  <!-- <ul>
                    <li>
                      <a href="javascript:void(0);"
                        ><img src="@/assets/admin/img/icons/emonji-02.svg" alt="Icon"
                      /></a>
                    </li>
                    <li>
                      <a href="javascript:void(0);"
                        ><img src="@/assets/admin/img/icons/emonji-05.svg" alt="Icon"
                      /></a>
                    </li>
                    <li>
                      <a href="javascript:void(0);"
                        ><img src="@/assets/admin/img/icons/emonji-06.svg" alt="Icon"
                      /></a>
                    </li>
                    <li>
                      <a href="javascript:void(0);"
                        ><img src="@/assets/admin/img/icons/emonji-07.svg" alt="Icon"
                      /></a>
                    </li>
                    <li>
                      <a href="javascript:void(0);"
                        ><img src="@/assets/admin/img/icons/emonji-08.svg" alt="Icon"
                      /></a>
                    </li>
                    <li class="add-emoj">
                ...
                <a
                  href="javascript:void(0);"
                  class="action-circle p-2 border rounded-circle d-flex align-items-center justify-content-center me-1"
                  ><i class="ti ti-mood-smile"></i
                ></a>
              </div>
              <div class="form-item">
                <a
                  href="javascript:void(0);"
                  class="action-circle p-2 border rounded-circle d-flex align-items-center justify-content-center me-3"
