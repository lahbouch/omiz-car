<template>
    ...
    <div class="content me-4">
      ...
      >
        <div class="my-auto mb-2">
          <h2 class="mb-1">Safety Features</h2>
          <nav>
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item">
                <router-link to="/admin-template/index">Home</router-link>
              </li>
              <li class="breadcrumb-item active" aria-current="page">Safety Features</li>
            </ol>
          </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          ...
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-plus me-2"></i>Add New Safety Feature</a
            >
          </div>
        </div>
      </div>
      ...
      <div class="custom-datatable-filter table-responsive">
        ...
        >
          <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'SAFETYFEATURE'">
              <h6 class="fw-medium">
                <a href="javascript:void(0);">{{ record.SAFETYFEATURE }}</a>
              </h6>
            </template>
  ...
  <!-- /Page Wrapper -->
  <safety-features-modal></safety-features-modal>
</template>
<script>
const columns = [
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.SAFETYFEATURE.toLowerCase();
        b = b.SAFETYFEATURE.toLowerCase();
