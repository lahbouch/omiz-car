        ...
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-plus me-2"></i>Add New Seat Type</a
            >
          </div>
        </div>
      </div>
        ...
        >
          <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'SEATTYPE'">
              <h6 class="fw-medium">
                <a href="javascript:void(0);">{{ record.SEATTYPE }}</a>
              </h6>
            </template>
...
const columns = [
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.SEATTYPE.toLowerCase();
        b = b.SEATTYPE.toLowerCase();
