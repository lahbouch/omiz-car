    ...
    <div class="content me-4">
      ...
      >
        <div class="my-auto mb-2">
          <h2 class="mb-1">Steering</h2>
          <nav>
            <ol class="breadcrumb mb-0">
              <li class="breadcrumb-item">
                <router-link to="/admin-template/index">Home</router-link>
              </li>
              <li class="breadcrumb-item active" aria-current="page">Steering</li>
            </ol>
          </nav>
        </div>
        <div class="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div class="mb-2">
            <a
              ...
              ><i class="ti ti-plus me-2"></i>Add New Steering</a
            >
          </div>
        </div>
      </div>
...
const columns = [
  {
    ...
    sorter: {
      compare: (a, b) => {
        a = a.STEERINGTYPE.toLowerCase();
        b = b.STEERINGTYPE.toLowerCase();
