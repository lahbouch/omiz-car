        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
          <div>
            <div class="d-flex align-items-center flex-wrap gap-2 mb-2">
              ...
              <span class="badge badge-md bg-secondary-transparent"
                >Rent in Progress</span
              >
            </div>
          ...
          <div class="card mb-4 mb-xl-0">
            ...
            <div class="card-body">
              <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="car-info">
                  <div class="border-bottom mb-3 pb-3">
                    <div class="row">
                      ...
                      <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="mb-3">
                          <h6 class="fs-14 fw-semibold mb-1">No of Air Bags</h6>
                          <p class="fs-13">06</p>
                        </div>
                      </div>
                      <div class="col-lg-12">
                ...
                <div class="tab-pane fade" id="car-price">
                  <div class="border-bottom mb-3 pb-3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="mb-3">
                          <h6 class="fs-14 fw-semibold mb-1">Yearly</h6>
                          <p class="fs-13">$6000</p>
                        </div>
                      </div>
                      <div class="col-xxl-3 col-md-4 col-sm-6">
                        <div class="mb-3">
                  ...
                  <div>
                    ...
                    <div class="d-flex flex-column gap-2">
                      <div
                        class="d-flex align-items-center justify-content-between flex-wrap bg-light gap-3 br-5 p-20"
                      >
                        <div>
                      ...
                      >
                        <div>
                          ...
                          <div class="d-flex align-items-center gap-2 flex-wrap">
                            ...
                            <p class="fs-13 fw-medium mb-0">
                              Kilometers Extra Price :
                              <span class="text-gray-9">$120</span>
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <!-- Damages -->
                <div class="tab-pane fade" id="car-damages">
                  <div
                    class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3"
                  >
                    <h6>Damages</h6>
                  ...
                  <div class="d-flex flex-column gap-2">
                    <div class="bg-white p-20 br-5 border">
                    ...
                    <div class="bg-white p-20 br-5 border">
                      <div class="row align-items-center row-gap-3">
                        <div class="col-xxl-8 col-md-7">
                          <div class="d-flex align-items-center gap-2 mb-1">
                            <h6 class="fs-14 fw-medium">Electrical Issues</h6>
                            <span class="badge bg-pink-transparent badge-sm"
                              >Interior</span
                            >
                          </div>
              ...
              <div class="summary-wrap">
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">23</h6>
                    <span
                ...
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">22</h6>
                    <span
                      class="d-inline-block fw-medium fs-12 bg-light p-1 d-inline-block rounded-1 text-gray-9"
                      >Feb, 2025</span
                    >
                  ...
                  <div>
                    <h6 class="fs-14 fw-semibold mb-1">Damage</h6>
                    <p class="fs-13">
                      Damage is added on the
                      <span class="text-gray-9 fw-medium">Exterior</span>
                    </p>
                  </div>
                </div>
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">21</h6>
                    <span
                      class="d-inline-block fw-medium fs-12 bg-light p-1 d-inline-block rounded-1 text-gray-9"
                      >Feb, 2025</span
                    >
                  ...
                  <div>
                    <h6 class="fs-14 fw-semibold mb-1">Maintainance</h6>
                    <p class="fs-13">
                      Car status Changes as
                      <span class="text-gray-9 fw-medium">Maintainance</span>
                    </p>
                  </div>
                </div>
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">20</h6>
                    <span
                      class="d-inline-block fw-medium fs-12 bg-light p-1 d-inline-block rounded-1 text-gray-9"
                      >Feb, 2025</span
                    >
                ...
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">19</h6>
                    <span
                      class="d-inline-block fw-medium fs-12 bg-light p-1 d-inline-block rounded-1 text-gray-9"
                      >Feb, 2025</span
                    >
                  ...
                  <div>
                    <h6 class="fs-14 fw-semibold mb-1">Booking</h6>
                    <p class="fs-13">
                      Car is Booked By
                      <span class="text-gray-9 fw-medium">James Anderson</span>
                    </p>
                  </div>
                </div>
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">11</h6>
                    <span
                      class="d-inline-block fw-medium fs-12 bg-light p-1 d-inline-block rounded-1 text-gray-9"
                      >Feb, 2025</span
                    >
                  ...
                  <div>
                    <h6 class="fs-14 fw-semibold mb-1">User</h6>
                    <p class="fs-13">
                      User logged in &
                      <span class="text-gray-9 fw-medium">Details Updated</span>
                    </p>
                  </div>
                </div>
                <div class="d-flex align-items-center">
                  <div class="border br-5 text-center flex-shrink-0 p-1 me-3">
                    <h6 class="fw-semibold mb-1">09</h6>
                    <span
                      class="d-inline-block fw-medium fs-12 bg-light p-1 d-inline-block rounded-1 text-gray-9"
                      >Feb, 2025</span
                    >
                  ...
                  <div>
                    ...
                    <p class="fs-13">
                      ...
                      <span class="text-gray-9 fw-medium">Admin</span>
                    </p>
                  </div>
                </div>
              </div>
