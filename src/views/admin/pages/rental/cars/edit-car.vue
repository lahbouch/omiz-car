              ...
              <form action="#">
                ...
                <div class="border-bottom mb-4 pb-4">
                  <div class="row row-gap-4">
                    ...
                    <div class="col-xl-9">
                      <div
                        class="d-flex align-items-center flex-wrap row-gap-3 upload-pic"
                      >
                        <div
                  ...
                  <div class="row row-gap-4">
                    ...
                    <div class="col-xl-9">
                      ...
                      <div class="mb-3">
                        ...
                        />
                        <p class="fs-13 fw-medium mt-1">
                          Preview :
                          <a href="javascript:void(0);" class="link-info"
                            >https://www.example.com/cars/</a
                          >
                        </p>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                          <div class="mb-3">
                            ...
                            <vue-select
                              ...
                              placeholder="Johnson Dealer Zone"
                            />
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                          <div class="mb-3">
                            ...
                            <vue-select
                              ...
                              placeholder="Allen Dealer Parking Lot"
                            />
                          </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                ...
                <div class="d-flex align-items-center justify-content-end pt-3">
                  ...
                  <button
                    ...
                    type="button"
                  >
                    Add Features<i class="ti ti-chevron-right ms-1"></i>
                  </button>
                </div>
              </form>
            </fieldset>
              ...
              <form action="#">
                ...
                <div class="d-flex align-items-center justify-content-end pt-3">
                  ...
                  <button
                    ...
                    :disabled="currentStep === totalSteps"
                  >
                    Add Tariff & Pricing<i class="ti ti-chevron-right ms-1"></i>
                  </button>
                </div>
              </form>
            </fieldset>
                    ...
                    <div class="col-xl-9">
                      ...
                      >
                        <a
                          ...
                          ><i class="ti ti-plus me-1"></i>Add New Tarrif Rate</a
                        >
                      </div>
                          ...
                          >
                            <div>
                              ...
                              <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <p class="fs-13 fw-medium mb-0">
                                  Benefits : <span class="text-gray-9">04</span>
                                </p>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
                          ...
                          >
                            <div>
                              ...
                              <div class="d-flex align-items-center gap-2 flex-wrap">
                                ...
                                <p class="fs-13 fw-medium mb-0">
                                  Benefits : <span class="text-gray-9">06</span>
                                </p>
                              </div>
                            </div>
                            <div class="d-flex align-items-center">
...
export default {
  data() {
    return {
      ...
      MainLocation: [
        { label: "Select", value: "Select" },
        { label: "Johnson Dealer Zone", value: "Johnson Dealer Zone" },
        { label: "Miller Auto Trade Zone", value: "Miller Auto Trade Zone" },
        { label: "Thompson Dealer Parking", value: "Thompson Dealer Parking" },
      ],
      Otherlocation: [
      ...
      Doors: [
        { label: "Select", value: "Select" },
        { label: "2 Doors", value: "2 Doors" },
        { label: "3 Doors", value: "3 Doors" },
        { label: "4 Doors", value: "4 Doors" },
      ],
      Platform: [
