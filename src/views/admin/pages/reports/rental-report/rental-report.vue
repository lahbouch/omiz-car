              ...
              <div class="card flex-fill position-relative orange-highlights">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <span class="fs-14 fw-normal text-truncate d-block mb-2"
                        >Total Bookings</span
                      >
                      <div class="d-flex align-items-center">
                        <h6 class="me-1 fw-semibold">5,450</h6>
                        <p
                          class="fs-12 fw-normal d-flex align-items-center justify-content-center text-truncate"
                        >
                          Rentals
                    ...
                    <a
                      href="javascript:void(0);"
                      class="avatar avatar-md avatar-rounded bg-orange-transparent border border-primary"
                    >
              ...
              <div class="card flex-fill position-relative success-highlights">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a
                      href="javascript:void(0);"
                      class="avatar avatar-md avatar-rounded bg-success-transparent border border-success"
                    >
              ...
              <div class="card flex-fill position-relative info-highlights">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a
                      href="javascript:void(0);"
                      class="avatar avatar-md avatar-rounded bg-info-transparent border border-info"
                    >
                ...
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      ...
                      >
                      <div class="d-flex align-items-center">
                        <h6 class="me-1 fw-semibold">
                          4.7<span class="text-gray-5">/5</span>
                        </h6>
                        <p
                          class="fs-12 fw-normal d-flex align-items-center justify-content-center text-truncate"
                        >
                    ...
                    <a
                      href="javascript:void(0);"
                      class="avatar avatar-md avatar-rounded bg-danger-transparent border border-danger"
                    >
          ...
          <div class="card flex-fill earnings-chart">
            <div class="card-header border-0 pb-0">
              <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                  <span
                    class="avatar avatar-md avatar-rounded bg-orange-transparent border-orange me-2"
                    ><i class="ti ti-bookmarks fs-14 text-orange"></i
                  ></span>
            ...
            <div class="card-body py-0">
              <div id="total-bookings">
                <apexchart
                  type="bar"
                  height="350"
                  :options="totalBookingsChart.bookingChart"
                  :series="totalBookingsChart.series"
                >
                </apexchart>
              </div>
            </div>
          ...
          <div class="card flex-fill earnings-chart">
            <div class="card-header border-0 pb-0">
              <div class="d-flex flex-wrap justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                  <span
                    class="avatar avatar-md avatar-rounded bg-success-transparent border-success me-2"
                    ><i class="ti ti-car fs-14 text-success"></i
                  ></span>
            ...
            <div class="card-body py-0">
              <div id="chart">
                <apexchart
                  type="donut"
                  :options="rentalChart.totalChart"
                  :series="rentalChart.series"
                >
                </apexchart>
              </div>
              <div>
                <ul class="breakdown-reports">
                  <li>
                    <p class="text-gray-9 fs-10 d-flex align-items-center mb-0">
                      <i class="ti ti-point-filled text-danger me-1"></i>Ford Endeavour
                    </p>
                    <span class="fs-10 text-gray-5">245</span>
                  </li>
                  <li>
                    <p class="text-gray-9 fs-10 d-flex align-items-center mb-0">
                      <i class="ti ti-point-filled text-teal me-1"></i>Ferrari 458 MM
                    </p>
                    <span class="fs-10 text-gray-5">286</span>
                  </li>
                  <li>
                    <p class="text-gray-9 fs-10 d-flex align-items-center mb-0">
                      <i class="ti ti-point-filled text-warning me-1"></i>Ford Mustang
                    </p>
                  ...
                  <li>
                    ...
                    >
                      <span class="d-inline-flex align-items-center"
                        ><i class="ti ti-grip-vertical me-1"></i>INVOICE NO</span
                      >
        ...
        <div class="filterbox mb-3 d-flex align-items-center">
          ...
          <div class="dropdown me-2">
            ...
            <ul class="dropdown-menu dropdown-menu-lg p-2">
              ...
              <li>
                <label class="dropdown-item d-flex align-items-center rounded-1">
                  <input class="form-check-input m-0 me-2" type="checkbox" />Ferrari 458
                  MM
                </label>
              </li>
              <li>
              ...
              <li>
                <label class="dropdown-item d-flex align-items-center rounded-1">
                  <input class="form-check-input m-0 me-2" type="checkbox" />Toyota Tacoma
                  4
                </label>
              </li>
              <li>
              ...
              <li>
                <label class="dropdown-item d-flex align-items-center rounded-1">
                  <input class="form-check-input m-0 me-2" type="checkbox" />Acura Sport
                  Version
                </label>
              </li>
              <li>
              ...
              <li>
                <label class="dropdown-item d-flex align-items-center rounded-1">
                  <input class="form-check-input m-0 me-2" type="checkbox" />Toyota Camry
                  SE 350
                </label>
              </li>
            </ul>
...
<script>
import { totalBookingsChart, rentalChart } from "./data";
...
export default {
  data() {
    return {
      ...
      totalBookingsChart: totalBookingsChart,
    };
  },
  setup() {
