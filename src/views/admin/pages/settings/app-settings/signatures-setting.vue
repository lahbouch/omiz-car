              ...
              >
                ...
                >
                  <a
                    ...
                    ><i class="ti ti-plus me-2"></i>Add New Signature</a
                  >
                </div>
              </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <img src="@/assets/admin/img/icons/sign.svg" alt="" />
                      </td>
                      <td>
                        <span
                    ...
                    <tr>
                      <td>
                        <h6 class="fw-medium">
                          <a href="javascript:void(0);">Raymond</a>
                        </h6>
                      </td>
                      <td>
                        <img src="@/assets/admin/img/icons/sign.svg" alt="" />
                      ...
                      <td>
                        <span
                          class="badge badge-danger-transparent d-inline-flex align-items-center badge-sm"
                        >
            ...
            <div class="row">
              ...
              <div class="mb-0">
                <label class="form-label"
                  >Signature Name <span class="text-danger">*</span></label
                >
                ...
                <div class="d-flex align-items-center flex-wrap row-gap-3 mb-3">
                  ...
                  >
                    <img
                      ...
                      alt="img"
                    />
                    <span class="avatar-badge bg-light text-danger m-1"
