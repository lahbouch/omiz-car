<template>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="mb-3">System Backup</h6>
                <a
              ...
              <div class="custom-datatable-filter table-responsive">
                <table class="table">
                  ...
                  <tbody>
                          ...
                          <ul class="dropdown-menu dropdown-menu-end p-2">
                            <li>
                              <a
                                ...
                                href="javascript:void(0);"
                                ><i class="ti ti-restore me-1"></i>Restore</a
                              >
                            </li>
                            <li>
                              <a
                    ...
                    <tr>
                      <td>
                        <h6 class="fw-semibold fs-14">Bookings_Backup_Sep_2024.txt</h6>
                      </td>
                      <td>
                    ...
                    <tr>
                      <td>
                        <h6 class="fw-semibold fs-14">Customers_Backup_Sep_2024.txt</h6>
                      </td>
                      <td>
  ...
  <system-backup-modal></system-backup-modal>
</template>
