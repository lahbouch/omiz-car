  ...
  <div class="page-wrapper">
    <div class="content me-0 pb-0 me-lg-4">
      ...
      <div class="row">
        <div class="col-lg-3">
          <!-- inner sidebar -->
          <adminsettings-sidebar></adminsettings-sidebar>
          <!-- /inner sidebar -->
        </div>
        <div class="col-lg-9">
          <div class="card">
              ...
              >
                ...
                >
                  <a
                    ...
                    ><i class="ti ti-plus me-2"></i>Add New Template</a
                  >
                </div>
              </div>
                      ...
                      <td>
                        <h6 class="fw-medium">
                          <a
                            ...
                            data-bs-toggle="modal"
                            data-bs-target="#view_email"
                            >Seasonal Promotions & Discounts</a
                          >
                        </h6>
                      </td>
                      <td>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="border br-10 p-2 mb-3">
                  ...
                  <p>
                    We’re thrilled to have you as part of our community and are excited to
                    support you in finding the perfect car rental solution. Thank you for
                    choosing us – we truly appreciate your trust and confidence.
                  </p>
                  <p>
                    At <span class="text-info">{Company Name}</span>, our mission is to
                    make your experience as smooth and efficient as possible. Whether
                    you’re looking for the perfect vehicle or need assistance with
                    booking, we’re here to help you every step of the way. If you have any
                    questions or need help, our dedicated support team is always ready to
                    assist you. Feel free to reach out at any time – we’re committed to
                    ensuring you have the best experience possible
                  </p>
                  <p>
                    Thank you again for choosing
                    <span class="text-info">{Company Name}</span>. We’re excited to be
                    part of your journey and look forward to supporting you throughout
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-lg-12">
                ...
                <p>
                  At <span class="text-info">{Company Name}</span>, our mission is to make
                  your experience as smooth and efficient as possible. Whether you’re
                  looking for the perfect vehicle or need assistance with booking, we’re
                  here to help you every step of the way. If you have any questions or
                  need help, our dedicated support team is always ready to assist you.
                  Feel free to reach out at any time – we’re committed to ensuring you
                  have the best experience possible
                </p>
                <p>
                  Thank you again for choosing
                  <span class="text-info">{Company Name}</span>. We’re excited to be part
                  of your journey and look forward to supporting you throughout your
                  rental experience.
                </p>
                <p>
                  Best <br />
