          ...
          <div class="card">
            ...
            <div class="card-body d-flex flex-wrap gap-2">
              <span class="avatar avatar-xl me-2 avatar-rounded">
                <img src="@/assets/admin/img/profiles/avatar-02.jpg" alt="img" />
              </span>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <span class="avatar avatar-xs me-2 online avatar-rounded">
                <img src="@/assets/admin/img/profiles/avatar-03.jpg" alt="img" />
              </span>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="avatar-list-stacked avatar-group-lg mb-4">
                <span class="avatar">
                  <img src="@/assets/admin/img/profiles/avatar-04.jpg" alt="img" />
                </span>
                <span class="avatar">
                  <img src="@/assets/admin/img/profiles/avatar-04.jpg" alt="img" />
                </span>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="avatar-list-stacked avatar-group-lg mb-4">
                ...
                <span class="avatar avatar-rounded">
                  <img src="@/assets/admin/img/profiles/avatar-05.jpg" alt="img" />
                </span>
                <a
