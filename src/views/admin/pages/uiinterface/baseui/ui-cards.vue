    ...
    <div class="content">
      ...
      <div class="row">
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="card">
            <img src="@/assets/admin/img/media/img-01.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="card">
            <img src="@/assets/admin/img/media/img-02.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
              <p class="card-text">
        ...
        <div class="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
          <div class="card">
            <img src="@/assets/admin/img/media/img-03.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
              <h6 class="card-title fw-semibold">Card title</h6>
              <p class="card-text">
                Some quick example text to build on the card title and make up the bulk of
        ...
        <div class="col-xxl-6 col-xl-6 col-lg-12">
          ...
          <div class="row row-cols-12">
            <div class="col">
              <div class="card">
                <div class="card-body">
                  <img src="@/assets/admin/img/media/img-04.jpg" class="card-img mb-3" alt="..." />
            ...
            <div class="col">
              <div class="card">
                <div class="card-body">
                  <img src="@/assets/admin/img/media/img-05.jpg" class="card-img mb-3" alt="..." />
            ...
            <div class="col">
              <div class="card">
                <div class="card-body">
                  <img src="@/assets/admin/img/media/img-02.jpg" class="card-img mb-3" alt="..." />
                ...
                <div class="card-body">
                  <div class="mb-2">
                    <span class="avatar avatar-md">
                      <img src="@/assets/admin/img/media/img-01.jpg" alt="img" />
                    </span>
                  </div>
            ...
            <div class="col-xl-4">
              <div class="card text-center">
                <div class="card-body">
                  <div class="mb-2">
                    <span class="avatar avatar-md">
                      <img src="@/assets/admin/img/media/img-02.jpg" alt="img" />
                    </span>
                  </div>
            ...
            <div class="col-xl-4">
              <div class="card text-end">
                <div class="card-body">
                  <div class="mb-2">
                    <span class="avatar avatar-md">
                      <img src="@/assets/admin/img/media/img-03.jpg" alt="img" />
                    </span>
                  </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-2">
          <div class="card">
            <div class="card-body">
              <img src="@/assets/admin/img/media/img-1.jpg" class="card-img mb-3" alt="..." />
        ...
        <div class="col-xl-2">
          <div class="card">
            <div class="card-body">
              <img src="@/assets/admin/img/media/img-2.jpg" class="card-img mb-3" alt="..." />
              <h6 class="card-title fw-semibold mb-3">
        ...
        <div class="col-xl-2">
          <div class="card">
            <div class="card-body">
              <img src="@/assets/admin/img/media/img-3.jpg" class="card-img mb-3" alt="..." />
              <h6 class="card-title fw-semibold mb-3">
      ...
      <div class="row">
        ...
        <div class="col-xl-4">
          <div class="card">
            ...
            <img src="@/assets/admin/img/media/img-02.jpg" class="card-img-bottom" alt="..." />
          </div>
        </div>
        <div class="col-xl-4">
          <div class="card">
            ...
            <img src="@/assets/admin/img/media/img-2.jpg" class="card-img rounded-0" alt="..." />
            <div class="card-body">
              <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
            </div>
          </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            ...
            <img src="@/assets/admin/img/media/img-04.jpg" class="card-img rounded-0" alt="..." />
            <div class="card-footer">
              <p class="card-text mb-0"><small>Last updated 3 mins ago</small></p>
            </div>
          </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <img src="@/assets/admin/img/media/img-05.jpg" class="card-img-top" alt="..." />
            <div class="card-header">
              <div class="card-title">Image caps are widely used in Blog's</div>
            </div>
            <div class="card-body">
        ...
        <div class="col-xl-4">
          <div class="card">
            ...
            <img src="@/assets/admin/img/media/img-1.jpg" class="card-img-bottom" alt="..." />
          </div>
        </div>
      </div>
      <!-- /Image Caps -->
      ...
      <div class="row">
        <div class="col-xl-4">
          <div class="card overlay-card">
            <img src="@/assets/admin/img/media/img-2.jpg" class="card-img" alt="..." />
        ...
        <div class="col-xl-4">
          <div class="card overlay-card">
            <img src="@/assets/admin/img/media/img-3.jpg" class="card-img" alt="..." />
        ...
        <div class="col-xl-4">
          <div class="card overlay-card">
            <img src="@/assets/admin/img/media/img-4.jpg" class="card-img" alt="..." />
            <div class="card-img-overlay d-flex flex-column p-0">
              <div class="card-header">
                <div class="card-title text-fixed-white">Image Overlays Are Awesome!</div>
              </div>
      ...
      <div class="row">
        <div class="col-xxl-3 col-xl-12">
          <div class="card">
            ...
            <img src="@/assets/admin/img/media/img-1.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
        ...
        <div class="col-xxl-3 col-xl-6">
          <div class="card">
            <a href="javascript:void(0);" class="card-anchor"></a>
            <img src="@/assets/admin/img/media/img-4.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="row row-cols-1 row-cols-md-4 g-4">
            ...
            <div class="col">
              <div class="card">
                <img src="@/assets/admin/img/media/img-04.jpg" class="card-img-top" alt="..." />
                <div class="card-body">
