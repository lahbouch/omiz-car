          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                ...
                <button
                  type="button"
                  class="btn btn-primary waves-effect waves-light mt-1 me-2"
                  data-bs-toggle="modal"
                ...
                <button
                  type="button"
                  class="btn btn-secondary waves-effect waves-light mt-1 me-2"
                  data-bs-toggle="modal"
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="bd-example">
                ...
                <button
                  type="button"
                  class="btn btn-danger mb-1 me-2"
                  data-bs-toggle="modal"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="button-list">
                ...
                <button
                  type="button"
                  class="btn btn-success mt-1 me-2"
                  data-bs-toggle="modal"
                ...
                <button
                  type="button"
                  class="btn btn-danger mt-1 me-2"
                  data-bs-toggle="modal"
