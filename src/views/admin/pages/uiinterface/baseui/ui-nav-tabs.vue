            ...
            <div class="card-body">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane text-muted" id="license1" role="tabpanel">
                  ...
                  by the
                  <b><i>Readable content</i></b> of a page when looking at its
            ...
            <div class="card-body">
              ...
              >
                ...
                <a
                  ...
                  aria-selected="true"
                  >Cart
                  <span class="badge bg-info-transparent ms-1">Full</span></a
                >
                <a
                  class="nav-link"
                  data-bs-toggle="tab"
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-xl-3">
                  <ul
                    class="nav nav-tabs flex-column nav-style-4"
                    role="tablist"
                  >
                    <li class="nav-item">
                      <a
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-xl-3">
                  <nav
                    class="nav nav-tabs flex-column nav-style-5"
                    role="tablist"
                  >
                    <a
                      class="nav-link"
                      ...
                      aria-selected="false"
                      ><i
                        class="fa-solid fa-house me-2 align-middle d-inline-block"
                      ></i
                      >Home</a
                    >
                    <a
                    ...
                    >
                      ...
                      <b
                        ><i
                          ...
                          thai restaurant youtube videos</i
                        ></b
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="declined" role="tabpanel">
                  <div class="text-muted">
                    ...
                    form, <b>by injected humour</b>, or randomised words which
              ...
              >
                ...
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i class="feather-shopping-bag me-1 align-middle"></i
                    >Shipped
                  </button>
                </li>
                <li class="nav-item" role="presentation">
      ...
      <div class="row">
        <div class="col-xl-4">
          <div class="card">
            ...
            <div class="card-body">
              <ul
                class="nav nav-tabs mb-3 tab-style-6"
                id="myTab-3"
                role="tablist"
              >
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="true"
                  >
                    <i class="feather-gift me-1 align-middle d-inline-block"></i
                    >Products
                  </button>
                </li>
                <li class="nav-item" role="presentation">
                  <button
                    ...
                    aria-selected="false"
                  >
                    <i class="feather-file me-1 align-middle d-inline-block"></i
                    >Sales
                  </button>
                </li>
                <li class="nav-item" role="presentation">
                  ...
                  >
                    <i
                      class="feather-file-text me-1 align-middle d-inline-block"
                    ></i
                    >Profit
                  </button>
                </li>
                <li class="nav-item" role="presentation">
                  ...
                  >
                    <i
                      class="feather-file-minus me-1 align-middle d-inline-block"
                    ></i
                    >Expenses
                  </button>
                </li>
                    ...
                    <li class="mb-3">
                      <div class="d-flex justify-content-between">
                        ...
                        <div class="fs-14 fw-semibold text-success">
                          <i class="ri-arrow-up-s-fill me-1 align-middle"></i
                          >22.75%
                        </div>
                      </div>
                    </li>
              ...
              <div class="row">
                <div class="col-md-3">
                  ...
                  >
                    ...
                    >
                      <i
                        class="feather-user me-1 align-middle d-inline-block"
                      ></i
                      >Profile
                    </button>
                    <button
                    ...
                    >
                      <i
                        class="feather-monitor me-1 align-middle d-inline-block"
                      ></i
                      >Password
                    </button>
                    <button
                    ...
                    >
                      <i
                        class="feather-users me-1 align-middle d-inline-block"
                      ></i
                      >Team
                    </button>
                    <button
                    ...
                    >
                      <i
                        class="feather-file me-1 align-middle d-inline-block"
                      ></i
                      >Billing
                    </button>
                    <button
                    ...
                    >
                      <i
                        class="feather-mail me-1 align-middle d-inline-block"
                      ></i
                      >Email
                    </button>
                  </div>
                      ...
                      <div class="d-sm-flex">
                        ...
                        <div>
                          <div class="my-md-auto mt-4 ms-md-3">
                            <h5 class="font-weight-semibold mb-1 pb-0">
                              Adam Smith
                            </h5>
                            <p class="text-muted ms-0 mb-2 pb-2">
                              ...
                              >
                              <span
                                ><i class="far fa-flag me-2"></i>New
                                Jersey</span
                              >
                            </p>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-4">
                  <ul
                    class="nav nav-tabs flex-column vertical-tabs-3"
                    role="tablist"
                  >
                    <li class="nav-item">
                      <a
                      ...
                      >
                        <i
                          class="feather-user me-2 align-middle d-inline-block"
                        ></i
                        >Employees
                      </a>
                    </li>
                    <li class="nav-item">
                      ...
                      >
                        <i
                          class="feather-users me-2 align-middle d-inline-block"
                        ></i
                        >Customers
                      </a>
                    </li>
                    <li class="nav-item">
                      ...
                      >
                        <i
                          class="feather-gift me-2 align-middle d-inline-block"
                        ></i
                        >Products
                      </a>
                    </li>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card">
            ...
            <div class="card-body">
              <ul class="nav nav-tabs nav-tabs-bottom tab-dark mb-3">
                <li class="nav-item">
                  <a
                    class="nav-link active"
                    href="#bottom-tabs1"
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#bottom-tabs2" data-bs-toggle="tab"
                    >Profile</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#bottom-tabs3" data-bs-toggle="tab"
                    >Messages</a
                  >
                </li>
              </ul>
              ...
              <div class="tab-content">
                <div class="tab-pane show active" id="bottom-tabs1">
                  Tab content 1
                </div>
                <div class="tab-pane" id="bottom-tabs2">Tab content 2</div>
                <div class="tab-pane" id="bottom-tabs3">Tab content 3</div>
              </div>
            </div>
          </div>
        </div>
