        ...
        <div class="listing-content">
          <div class="listing-features d-flex align-items-end justify-content-between">
            <div class="list-rating">
              ...
              <h3 class="listing-title">
                <router-link to="/listing/listing-details">{{ item.Title }}</router-link>
              </h3>
              <div class="list-rating">
          ...
          <div class="listing-button">
            <router-link to="/listing/listing-details" class="btn btn-order"
              ><span><i class="feather-calendar me-2"></i></span>Rent Now</router-link
            >
          </div>
        </div>
...
import Toyota from "@/assets/json/index-toyota.json";
