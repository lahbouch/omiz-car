            ...
            <div class="booking-information-main">
              <form @submit.prevent="submitForm">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="input-block">	
                          ...
                          <textarea class="form-control" placeholder="Enter Additional Information" rows="5"></textarea>
                        </div>
                      </div>
                      <div class="col-md-12">
                ...
                <div class="booking-info-btns d-flex justify-content-end">
                  <router-link to="/pages-booking/booking-addon" class="btn btn-secondary">Back to Extra Services</router-link>
              ...
              <div class="booking-sidebar-card">
                <div class="accordion-item border-0 mb-4">
                  <div class="accordion-header p-3 d-flex align-center justify-content-between">
                    ...
                    <router-link to="/pages-booking/booking-checkout" class="d-flex align-items-center sidebar-edit"><i class="bx bx-edit-alt me-2"></i>Edit</router-link>
                  </div>
                ...
                <div class="accordion-item border-0 mb-4">
                  <div class="accordion-header d-flex align-center justify-content-between p-3">
                    <div class="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#accordion_collapse_four" aria-expanded="true">
                      ...
                      <router-link to="/pages-booking/booking-addon" class="d-flex align-items-center sidebar-edit"><i class="bx bx-edit-alt me-2"></i>Edit</router-link>
                    </div>
                  </div>
              ...
              <div class="booking-sidebar-card">
                <div class="accordion-item border-0 mb-4">
                  ...
                  <div id="accordion_collapse_two" class="accordion-collapse collapse">
                    <div class="booking-sidebar-body">
                      <form action="/pages-booking/booking-detail">
                        <div class="d-flex align-items-center">
...
export default {
  data() {
    return {
      ...
      text: "Home",
      text1: "Checkout",
      AdultsSel: ["2 Adults, 1 Child", "5 Adults, 2 Child"],
      ConutryUSA: ["Country", "USA", "UK"],
    };
  },
  methods: {
    submitForm() {
      this.$router.push("/pages-booking/booking-payment");
    },
  },
};
</script>
