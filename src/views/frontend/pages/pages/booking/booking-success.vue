    ...
    <div class="container">
      ...
      <div class="booking-card">
        <div class="success-book">
          ...
          <h5 class="order-no">Order Number : <span>#123456</span></h5>
        </div>
        <div class="booking-header">
          <div class="booking-img-wrap">
            ...
            <div class="book-info">
              ...
              <p>
                <i class="feather-map-pin"></i> Location : Miami St, Destin, FL 32550, USA
              </p>
            </div>
          </div>
            ...
            <div class="book-card mb-0">
              ...
              <div class="book-body">
                <ul class="location-lists">
                  <li>
                    <p>
                      Rental companies typically require customers to return the vehicle
                      with a full tank of fuel. If the vehicle is returned with less than
                      a full tank, customers may be charged for refueling the vehicle at a
                      premium rate, often higher than local fuel prices.
                    </p>
                  </li>
                </ul>
              </div>
