                ...
                >
                  <template #bodyCell="{ column, record }">
                    ...
                    <template v-else-if="column.key === 'Status'">
                      <span class="badge badge-light-warning">{{ record.Status }}</span>
                    </template>
...
const data = [
  {
    ...
    Line: "18 Sep 2023, 09:00 AM",
    DropoffLocation: "26 Platinum Drive, Canonsburg",
    Line1: "15 Sep 2023, 11:30 AM",
  ...
  },
  {
    ...
    Line: "05 Nov 2023, 02:30 PM",
    DropoffLocation: "14 Roane Avenue, Herndon",
    Line1: "05 Dec 2023, 02:30 PM",
